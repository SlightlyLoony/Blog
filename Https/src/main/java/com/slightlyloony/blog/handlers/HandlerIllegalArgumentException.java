 ...
 */
public class HandlerIllegalArgumentException extends IllegalArgumentException {
    /**
     * Constructs an <code>IllegalArgumentException</code> with no detail message.
     */
    public HandlerIllegalArgumentException() {
    }
     ...
     */
    public HandlerIllegalArgumentException( final String s ) {
        super( s );
    }
     ...
     * <p>Note that the detail message associated with <code>cause</code> is <i>not</i> automatically incorporated in this exception's detail
     * message.</p>
     *
     ...
     * @since 1.5
     */
    public HandlerIllegalArgumentException( final String message, final Throwable cause ) {
        super( message, cause );
    }
     ...
     * @since 1.5
     */
    public HandlerIllegalArgumentException( final Throwable cause ) {
        super( cause );
    }
}

...
public class BlogObjectCache {
    ...
    public synchronized BlogObject get( final BlogID _id, final BlogObjectType _type ) {
    ...
    public synchronized void add( final BlogObject _obj ) {
    ...
    public synchronized void remove( final BlogID _id, final BlogObjectType _type ) {
